...
# object_data_sampler(data_folder='/media/nikita/WORK/sonar_dataset/obj_train_data',
#                     big_crop_folder='/media/nikita/WORK/sonar_dataset/norm_full',
#                     amp_folder='/media/nikita/WORK/sonar_dataset/norm_amp',
#                     im_folder='../../signal_labels_new/im_crop',
#                     re_folder='../../signal_labels_new/re_crop',
#                     res_folder='/media/nikita/WORK/sonar_dataset/dataset_obj',
#                     save_amp=True,
#                     save_complex=False,
#                     patch_length=5000,
#                     obj_size=0.8,
...
# background_data_sampler(data_folder='/media/nikita/WORK/sonar_dataset/obj_train_data',
#                         big_crop_folder='/media/nikita/WORK/sonar_dataset/norm_full',
#                         amp_folder='/media/nikita/WORK/sonar_dataset/norm_amp',
#                         im_folder='../../signal_labels_new/im_crop',
#                         re_folder='../../signal_labels_new/re_crop',
#                         res_folder='/media/nikita/WORK/sonar_dataset/dataset_back',
#                         save_amp=True,
#                         save_complex=False,
#                         total_num=15000,
#                         patch_length=5000,
...
#                         classes=[0, 1, 2])
#
folder_creator(object_folder='/media/nikita/WORK/sonar_dataset/dataset_obj',
               background_folder='/media/nikita/WORK/sonar_dataset/dataset_back',
               concat_amp=True,
